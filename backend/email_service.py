...
SENDGRID_FROM_NAME = os.getenv("SENDGRID_FROM_NAME", "S.C.O.P.E. FeedForward Coach")
...
def generate_html_report(assessment_data):
    ...
    <body>
        <div class="container">
            <div class="header">
                {logo_html}
                <h1 style="margin:0;">S.C.O.P.E. Coaching Session</h1>
                <p style="margin:5px 0 0 0; opacity: 0.9;">FeedForward Coaching Session</p>
            </div>
...
def send_assessment_email(to_email, assessment_data):
    ...
    message = Mail(
        ...
        to_emails=to_email,
        subject='Your S.C.O.P.E. Coaching Session Summary',
